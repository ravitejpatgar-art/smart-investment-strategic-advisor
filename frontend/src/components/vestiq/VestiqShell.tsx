...
export const VestiqShell: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-[#F8FAFC] dark:bg-[#07090e] text-slate-900 dark:text-slate-100 flex flex-col overflow-hidden font-sans selection:bg-[#00D4AA]/20 selection:text-[#0D9488]">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {/* Center: AI Workspace */}
        <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 flex flex-col justify-between min-w-0">
        ...
        <div className="hidden xl:flex p-4 border-l border-slate-200 dark:border-white/[0.08] bg-white dark:bg-[#0B1120] h-full overflow-y-auto">
