    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050816]/90 backdrop-blur-md border-b border-white/[0.08] px-4 lg:px-12 py-3.5 transition-all">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg bg-[#0A1022] border border-white/[0.08] text-[#8A94A6] hover:text-white transition-all cursor-pointer"
          ...
          >
            {theme === 'dark' ? (
              ...
              <Moon className="w-4 h-4 text-[#8A94A6]" />
            )}
          </button>
