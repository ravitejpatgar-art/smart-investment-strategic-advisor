...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-24 overflow-hidden bg-[#060811]">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-gradient-to-tr from-[#00D4AA]/10 via-[#38BDF8]/5 to-transparent rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-7">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0B1120] border border-white/[0.08] text-slate-300 text-xs font-semibold tracking-wide shadow-sm">
              <span className="w-2 h-2 rounded-full bg-[#00D4AA] animate-pulse" />
              <span className="text-white font-bold">INSTITUTIONAL WEALTH PLATFORM</span>
              <span className="text-slate-600">|</span>
              <span className="text-[#00D4AA]">FIDUCIARY STRATEGY</span>
            </div>

            {/* Authoritative Main Headline */}
            <h1 
              className="text-3xl sm:text-5xl lg:text-[54px] font-black tracking-[-0.035em] text-white leading-[1.12]"
              style={{ fontFamily: "'Inter Tight', 'Inter', sans-serif" }}
            >
              Professional Investment Planning <br className="hidden sm:inline" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00D4AA] via-[#38BDF8] to-emerald-300">
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-center gap-3 text-sm text-slate-200">
                ...
                <span><strong className="text-white">Fiduciary Direct Architecture:</strong> 0% commissions, zero distributor bias.</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-200">
                <CheckCircle2 className="w-4 h-4 text-[#00D4AA] shrink-0" />
                <span><strong className="text-white">Modern Portfolio Theory (MPT):</strong> Multi-asset risk-adjusted diversification.</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-200">
                <CheckCircle2 className="w-4 h-4 text-[#00D4AA] shrink-0" />
                <span><strong className="text-white">Lifecycle Goal Projections:</strong> Inflation-adjusted milestone roadmaps.</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-3">
              <button
                ...
                className="px-7 py-3.5 rounded-xl bg-[#00D4AA] text-[#060811] font-bold text-sm hover:bg-[#00D4AA]/90 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md hover:shadow-[#00D4AA]/25"
              >
              ...
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-[#0B1120] hover:bg-[#15203B] text-white border border-white/[0.10] font-semibold text-sm transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
              >
            ...
            {/* Trust Badges */}
            <div className="flex items-center gap-5 pt-4 text-xs text-slate-400 border-t border-white/[0.06]">
              <div className="flex items-center gap-1.5">
                <Shield className="w-3.5 h-3.5 text-[#00D4AA]" />
                <span className="text-slate-300">Non-Custodial Advisory</span>
              </div>
              <span className="text-slate-700">•</span>
              <div className="flex items-center gap-1.5">
                <TrendingUp className="w-3.5 h-3.5 text-[#38BDF8]" />
                <span className="text-slate-300">SEBI & Global Benchmarks</span>
              </div>
              <span className="text-slate-700">•</span>
              <div className="flex items-center gap-1.5">
          ...
          <div className="lg:col-span-6">
            <div className="bg-[#0F172A] border border-white/[0.10] rounded-2xl p-5 sm:p-6 shadow-2xl relative">
              
              {/* Dashboard Terminal Header */}
              <div className="flex items-center justify-between pb-4 mb-5 border-b border-white/[0.06]">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#0B1120] border border-white/[0.08] flex items-center justify-center">
                    <Layers className="w-4.5 h-4.5 text-[#00D4AA]" />
                  </div>
                  <div>
                    <div className="text-sm font-bold text-white tracking-tight">Institutional Portfolio Mandate</div>
                    <div className="text-[11px] text-slate-400">Client Portfolio #SV-9482 · Balanced Growth</div>
                  </div>
                </div>

                <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#00D4AA]/10 border border-[#00D4AA]/25 text-[#00D4AA] text-[11px] font-bold">
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                <div className="bg-[#0B1120] border border-white/[0.06] rounded-xl p-3">
                  ...
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-[10.5px] text-[#00D4AA] font-bold">Grade A</span>
                  </div>
                </div>
              ...
              {/* View Switcher Tabs */}
              <div className="flex items-center gap-1 bg-[#0B1120] p-1 rounded-xl border border-white/[0.06] mb-4 text-xs font-semibold">
                <button
