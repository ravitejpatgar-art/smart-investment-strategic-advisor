...
export const InteractiveCalculator: React.FC = () => {
  ...
  return (
    <section id="calculator" className="py-24 bg-[var(--color-bg)] relative">
      <div className="max-w-7xl mx-auto px-4 lg:px-12 relative z-10">
        ...
        <div className="max-w-5xl mx-auto bg-[var(--color-card)] rounded-xl p-6 sm:p-9 border border-[var(--color-border)] shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-xs font-bold text-[var(--color-text-secondary)] uppercase tracking-wider">Monthly Deployment</label>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-xs font-bold text-[var(--color-text-secondary)] uppercase tracking-wider">Expected Annual Return (CAGR)</label>
                ...
                <input 
                  ...
                  className="w-full h-1.5 bg-[var(--color-surface-hover)] rounded-lg appearance-none cursor-pointer accent-[#1E88E5]"
                />
                <div className="flex justify-between text-[11px] text-[var(--color-text-muted)] font-mono mt-1">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-xs font-bold text-[var(--color-text-secondary)] uppercase tracking-wider">Investment Horizon</label>
                ...
                <input 
                  ...
                  className="w-full h-1.5 bg-[var(--color-surface-hover)] rounded-lg appearance-none cursor-pointer accent-amber-400"
                />
                <div className="flex justify-between text-[11px] text-[var(--color-text-muted)] font-mono mt-1">
                  <span>1 Year</span>
                  <span>15 Years</span>
            ...
            <div className="lg:col-span-5 bg-[var(--color-surface)] rounded-xl p-5 border border-[var(--color-border)] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between pb-3 mb-4 border-b border-[var(--color-border)]">
                  <span className="text-[11px] font-bold text-[var(--color-text-secondary)] uppercase tracking-wider">Projected Portfolio Value</span>
                  <span className="text-xs font-bold text-[var(--color-accent)] px-2 py-0.5 rounded bg-[var(--color-accent-soft)] font-mono">
                    {calculation.wealthMultiplier}x Multiplier
                  </span>
                </div>

                <div className="text-2xl sm:text-3xl font-black text-[var(--color-text-primary)] mb-4 tracking-tight font-mono">
                ...
                <div className="space-y-2.5 pt-1 text-xs">
                  <div className="flex justify-between">
                    <span className="text-[var(--color-text-secondary)]">Total Capital Deployed:</span>
                    <span className="font-mono font-semibold text-[var(--color-text-primary)]">{formatCurrency(calculation.totalInvested)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[var(--color-text-secondary)]">Estimated Compounding Gains:</span>
                    <span className="font-mono font-bold text-[var(--color-accent)]">+{formatCurrency(calculation.estimatedGains)}</span>
                  </div>
                </div>

                <div className="w-full bg-[var(--color-card)] h-1.5 rounded-full overflow-hidden my-4 flex">
                  <div 
              ...
              <button
                ...
                className="w-full mt-4 py-2.5 px-4 rounded-lg bg-[var(--color-accent)] text-[var(--color-accent-text)] font-bold text-xs hover:opacity-90 transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-xs"
              >
