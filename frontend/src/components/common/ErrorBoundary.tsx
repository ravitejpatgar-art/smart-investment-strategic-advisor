          ...
          <div className="max-w-md w-full bg-[#101827] border border-white/[0.08] rounded-xl p-6 sm:p-8 shadow-2xl text-center space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <button
                ...
                className="w-full sm:w-auto px-4 py-2.5 rounded-lg bg-[var(--color-accent)] text-[var(--color-accent-text)] font-bold text-xs hover:brightness-105 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xs"
              >
